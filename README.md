...
```
git clone https://github.com/<@github_username>/recommender_system_leads.git
cd recommender_system_leads
```
...
* [recommender_system_leads](./recommender_system_leads/): main Python package with source of the model.
