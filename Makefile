IMAGE = recommender_system_leads
PACKAGE = recommender_system_leads
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ recommender_system_leads <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf recommender_system_leads.egg_info
